# -*- coding: utf-8 -*-
"""
Created on Sat Feb 23 14:30:23 2019

@author: drape
"""
from id3 import rand_id3, predict, accuracy, printTree
...
def main():
    ...
    treenums = [1,2,4,8,16,32,64]
    for k_val in [2,4,6]:    
        print("When you set your attribute subset values to", k_val, "you get the following.")
        trainAcc = []
        testAcc = []
        for num in treenums:
            treelist = []
            for i in range(num):
                ...
                newTree =  rand_id3(newTraining, labels, label_attr, labels[-1], 18, 'entropy', None, k_val)
    ...
    for i in range(40):
        ...
        for j in range(250):
            ...
            newTree = rand_id3(train_j, labels, label_attr, labels[-1], 18, 'entropy', None, 6)
